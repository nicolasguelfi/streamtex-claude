...
0. **Load guideline**: Read `custom/design-guideline.md` if present.
   Ensure refactored styles respect guideline constraints.
...
- When renaming or restructuring styles, maintain guideline compliance
